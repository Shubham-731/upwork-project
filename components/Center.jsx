        ...
        <div className="bg-white col-span-3 row-span-3 p-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center space-x-3">
              <button className="py-2 px-3 space-x-2 outline-none border rounded-lg border-slate-300 flex items-center text-sm">
          ...
          <div className="flex items-center space-x-3 justify-between">
            <div className="p-3 border border-slate-300 rounded-lg space-y-2">
              ...
              <ul className="flex items-center justify-end space-x-3">
                <li className="border border-slate-300 rounded-lg p-1">
                  <FaAngleLeft />
                </li>
                <li>1</li>
                <li>2</li>
